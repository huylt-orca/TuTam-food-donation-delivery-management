...
class CustomMapSearch extends StatefulWidget {
  ...
  final List<LatLng> branchesLocation;
  ...
  const CustomMapSearch(
      ...
      required this.branchesLocation,
  ...
  @override
  State<CustomMapSearch> createState() => _CustomMapSearchState();
}

class _CustomMapSearchState extends State<CustomMapSearch> {
        ...
        children: [
          Positioned.fill(
            ...
            children: [
              ...
              CircleLayer(
                circles: widget.branchesLocation
              ...
              MarkerLayer(
                markers: widget.branchesLocation
                    .map((e) => Marker(
                          width: 30.0,
                          height: 30.0,
