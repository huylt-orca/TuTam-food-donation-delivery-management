...
const Navigation = (props: Props) => {
  ...
  return (
    <Drawer {...props} hover={hover || hidden}>
      <VerticalNavHeader {...props} hover={hover || hidden}/>
      <StyledBoxForShadow
        ref={shadowRef}
        sx={{
          background: `linear-gradient(${customColor.tertiary} 40%,${hexToRGBA(
            customColor.tertiary,
            0.1
          )} 95%,${hexToRGBA(customColor.tertiary, 0.05)})`
        }}
      />
      <Box
