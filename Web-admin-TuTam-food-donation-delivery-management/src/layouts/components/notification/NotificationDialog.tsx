...
export default function NotificationDialog({
  ...
  const [filterNotification, setFilterNotification] = useState<FilterNotifcationModel>(new FilterNotifcationModel())
            ...
            >
              {notificationSelected.size === 0 ? (
                <Autocomplete
                  ...
                  fullWidth
                  renderInput={params => (
                    <TextField {...params} name='unit' placeholder='Trạng thái' label='Trạng thái' fullWidth />
                  )}
                        ...
                        return (
                          <TableRow hover key={index}>
                            <TableCell>
                              <Checkbox
                                onChange={() => {
                                  const newNotificationSelected = new Set(Array.from(notificationSelected))
