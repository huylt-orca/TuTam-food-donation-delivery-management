...
import { Box, CardMedia, Chip, CircularProgress, Grid, Stack, Typography } from '@mui/material'
      ...
      <Box sx={{ mt: 5 }}>
        <Grid container columnSpacing={3} sx={{ mb: 5 }}>
          <Grid item xs={12} md={4}>
            <CardMedia component='img' height='300' image={data.image} alt='img' sx={{ objectFit: 'contain' }} />
          </Grid>
          <Grid item xs={12} md={8}>
            {/* name */}
            <Typography gutterBottom variant='h4' component='div' textAlign={'center'} sx={{ mb: 3 }}>
              {data.name}
            </Typography>
