...
function ItemTargetTab({data}: any) {
  ...
  return (
    <Box sx={{p: 5}}>  
    {data?.targetProcessResponses.length === 0 &&  <Box sx={{height:"40px", width:"100%", display:"flex", justifyContent:"center", alignItems:"center", mt: 10, mb: 10}}>
      <Typography variant='h5' fontWeight={600} align='center'>
        Hiện chưa có vật phẩm của hoạt động này
      </Typography>
      </Box>}
              ...
              <Grid container columnSpacing={5} sx={{ mb: 10 }}>
                ...
                <Grid item xs={12} sm={6}>
                 ...
                 <Typography sx={{ mt: 3, fontSize: 14 }} variant='body1'>
                   Các thuộc tính: {b.itemTemplateResponse.attributeValues.map((a: any)=> 
                  ...
                  {/* <Stack direction='row' alignItems={'center'} spacing={3} sx={{mt: 4}}>
                    ...
                    <Typography sx={{ mt: 3, fontSize: 14 }} variant='body1'>
                      Số ngày hết hạn (dự tính): {b.itemTemplateResponse.estimatedExpirationDays}
                    </Typography>
                  </Stack> */}
